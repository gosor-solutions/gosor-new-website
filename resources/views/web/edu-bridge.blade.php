...
@section('content')
    <!-- Navigation Header -->
    <header class="sticky top-0 z-50 w-full border-b border-slate-200/80 dark:border-slate-800/80 bg-white/90 dark:bg-[#070b13]/90 backdrop-blur-md transition-all duration-200">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-20 items-center justify-between">
                ...
                <nav class="hidden lg:flex space-x-1 rtl:space-x-reverse items-center">
                    <a href="#student-app" class="px-3.5 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition">{{ __('edu_bridge.nav.student_app') }}</a>
                    <a href="#portals" class="px-3.5 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition">{{ __('edu_bridge.nav.portals') }}</a>
                    <a href="#features" class="px-3.5 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition">{{ __('edu_bridge.nav.features') }}</a>
                    <a href="#modules" class="px-3.5 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition">{{ __('edu_bridge.nav.modules') }}</a>
                    <a href="#pricing" class="px-3.5 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition">{{ __('edu_bridge.nav.pricing') }}</a>
                    <a href="#faq" class="px-3.5 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition">{{ __('edu_bridge.nav.faq') }}</a>
                </nav>

                <!-- Actions: Theme Toggle, Language Switcher, CTA -->
                <div class="flex items-center gap-2 sm:gap-3">
                    <!-- Theme Toggle -->
                    <button id="theme-toggle-btn" class="p-2.5 rounded-xl border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition cursor-pointer" aria-label="Toggle Theme">
                        <x-heroicon-o-sun class="w-5 h-5 hidden dark:block text-amber-400"/>
                        <x-heroicon-o-moon class="w-5 h-5 block dark:hidden text-slate-600"/>
                    </button>

                    <!-- Language Switcher -->
                    <div class="relative">
                        <button id="lang-dropdown-btn" class="flex items-center gap-1.5 px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-800 text-xs font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 transition cursor-pointer">
                            <x-heroicon-o-globe-alt class="w-4 h-4 text-indigo-600 dark:text-indigo-400"/>
                            <span>{{ app()->getLocale() === 'ar' ? 'العربية' : 'English' }}</span>
                            <x-heroicon-o-chevron-down class="w-3.5 h-3.5 opacity-60"/>
                        </button>
                        <div id="lang-dropdown-menu" class="hidden absolute end-0 mt-2 w-32 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl py-1 z-50 text-xs font-medium">
                            <a href="{{ route('set-locale', 'ar') }}" class="flex items-center justify-between px-3 py-2 hover:bg-indigo-50 dark:hover:bg-indigo-950/50 text-slate-700 dark:text-slate-200 {{ app()->getLocale() === 'ar' ? 'text-indigo-600 dark:text-indigo-400 font-bold' : '' }}">
                                <span>العربية</span>
                                @if(app()->getLocale() === 'ar') <span class="w-1.5 h-1.5 rounded-full bg-indigo-600"></span> @endif
                            </a>
                            <a href="{{ route('set-locale', 'en') }}" class="flex items-center justify-between px-3 py-2 hover:bg-indigo-50 dark:hover:bg-indigo-950/50 text-slate-700 dark:text-slate-200 {{ app()->getLocale() === 'en' ? 'text-indigo-600 dark:text-indigo-400 font-bold' : '' }}">
                                <span>English</span>
                                @if(app()->getLocale() === 'en') <span class="w-1.5 h-1.5 rounded-full bg-indigo-600"></span> @endif
                            </a>
                        </div>
                    </div>

                    <!-- Book Demo Button -->
                    <a href="#demo-form" class="hidden sm:inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-500 shadow-sm transition">
                        <span>{{ __('edu_bridge.nav.request_demo') }}</span>
                        <x-feathericon-arrow-right class="w-4 h-4 rtl:rotate-180"/>
                    </a>

                    <!-- Mobile Menu Button -->
                    <button id="mobile-menu-btn" class="lg:hidden p-2.5 rounded-xl border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition" aria-label="Toggle Mobile Menu">
        ...
        <!-- Mobile Drawer Menu -->
        <div id="mobile-menu-panel" class="lg:hidden max-h-0 opacity-0 overflow-hidden transition-all duration-300 bg-white/95 dark:bg-[#070b13]/95 border-b border-slate-200 dark:border-slate-800">
            <div class="px-4 pt-2 pb-6 space-y-2">
                <a href="#student-app" class="block px-3 py-2 rounded-lg text-sm font-medium text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800">{{ __('edu_bridge.nav.student_app') }}</a>
                <a href="#portals" class="block px-3 py-2 rounded-lg text-sm font-medium text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800">{{ __('edu_bridge.nav.portals') }}</a>
                <a href="#features" class="block px-3 py-2 rounded-lg text-sm font-medium text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800">{{ __('edu_bridge.nav.features') }}</a>
                <a href="#modules" class="block px-3 py-2 rounded-lg text-sm font-medium text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800">{{ __('edu_bridge.nav.modules') }}</a>
                <a href="#pricing" class="block px-3 py-2 rounded-lg text-sm font-medium text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800">{{ __('edu_bridge.nav.pricing') }}</a>
                <a href="#faq" class="block px-3 py-2 rounded-lg text-sm font-medium text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800">{{ __('edu_bridge.nav.faq') }}</a>
                <div class="pt-3">
                    <a href="#demo-form" class="w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-sm font-bold text-white bg-indigo-600 shadow-sm">
    ...
    <main class="relative overflow-hidden">
        ...
        <section class="relative pt-12 pb-16 lg:pt-16 lg:pb-24 overflow-hidden border-b border-slate-200/80 dark:border-slate-800/80">
            <!-- Subtle background tint -->
            <div class="pointer-events-none absolute inset-0 bg-radial from-indigo-50/40 via-transparent to-transparent dark:from-indigo-950/20 dark:via-transparent dark:to-transparent"></div>
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div class="lg:col-span-6 text-center lg:text-start space-y-6">
                        ...
                        <!-- Badge -->
                        <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-semibold bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-300 border border-indigo-200/80 dark:border-indigo-800/80">
                        ...
                        <h1 class="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-[1.25]">
                            ...
                            <span class="text-indigo-600 dark:text-indigo-400 underline decoration-indigo-300 dark:decoration-indigo-800 underline-offset-8">
                        ...
                        <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 pt-2">
                            <a href="#demo-form" class="w-full sm:w-auto px-7 py-3.5 text-sm font-bold text-white rounded-xl bg-indigo-600 hover:bg-indigo-500 shadow-sm transition flex items-center justify-center gap-2">
                                <span>{{ __('edu_bridge.hero.cta_primary') }}</span>
                                <x-feathericon-arrow-right class="w-4 h-4 rtl:rotate-180"/>
                            </a>
                            <a href="#student-app" class="w-full sm:w-auto px-7 py-3.5 text-sm font-bold text-slate-700 dark:text-slate-200 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 transition flex items-center justify-center gap-2">
                                <x-heroicon-o-device-phone-mobile class="w-4 h-4 text-indigo-600 dark:text-indigo-400"/>
                    ...
                    <div class="lg:col-span-6">
                        <div class="relative rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl overflow-hidden">
                            ...
                            <div class="px-4 py-3 bg-slate-100 dark:bg-slate-800/80 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
                                ...
                                <div class="px-3 py-0.5 rounded-md bg-white dark:bg-slate-900 text-[11px] font-mono text-slate-500 dark:text-slate-400 border border-slate-200 dark:border-slate-700 flex items-center gap-1.5">
                                    <x-heroicon-o-lock-closed class="w-3 h-3 text-emerald-500"/>
                            ...
                            <div class="p-5 sm:p-6 space-y-5 bg-slate-50/50 dark:bg-slate-950/40 text-xs">
                                
                                <!-- Academy Header Bar -->
                                <div class="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-800">
                                    <div class="flex items-center gap-2.5">
                                        <div class="w-8 h-8 rounded-lg bg-indigo-600 text-white font-bold flex items-center justify-center text-xs">
                                            EB
                                        </div>
                                        <div>
                                    ...
                                    <span class="px-2.5 py-1 rounded-md bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 font-semibold text-[11px] flex items-center gap-1">
                                ...
                                <div class="grid grid-cols-3 gap-3">
                                    ...
                                    <div class="p-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
                                        ...
                                        <div class="text-base font-bold text-indigo-600 dark:text-indigo-400 mt-0.5">6 حصص</div>
                                    </div>
                                    <div class="p-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
                                        <div class="text-slate-500 dark:text-slate-400 text-[10px]">{{ __('edu_bridge.hero.preview.attendance_rate') }}</div>
                                        <div class="text-base font-bold text-emerald-600 dark:text-emerald-400 mt-0.5">96.4%</div>
                                    </div>
                                </div>

                                <!-- Live Zoom Class Active Card -->
                                <div class="p-4 rounded-xl bg-white dark:bg-slate-900 border border-indigo-200 dark:border-indigo-900/60 shadow-xs space-y-2.5">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-2">
                                            <span class="w-2 h-2 rounded-full bg-rose-500 animate-ping"></span>
                                            <span class="font-bold text-rose-600 dark:text-rose-400 text-[11px]">{{ __('edu_bridge.hero.preview.live_now_badge') }}</span>
                                        </div>
                                    ...
                                    <div class="flex items-center justify-between pt-1">
                                        ...
                                        <button class="px-3 py-1 rounded-lg bg-indigo-600 text-white font-bold text-[10px]">
                                ...
                                <div class="flex items-center justify-between gap-2 pt-1">
                                    <button class="flex-1 py-2 px-2.5 rounded-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 font-semibold text-[10px] text-center hover:border-indigo-500 transition">
        ...
        <section id="student-app" class="py-16 lg:py-24 bg-slate-50/70 dark:bg-[#060911]/80 relative border-b border-slate-200/80 dark:border-slate-800/80">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
                
                <div class="text-center max-w-2xl mx-auto mb-14">
                    <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-300 border border-indigo-200/80 dark:border-indigo-800/80 mb-3">
                        <x-heroicon-o-device-phone-mobile class="w-4 h-4 text-indigo-600"/>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
                    ...
                    <div class="lg:col-span-4 space-y-4">
                        ...
                        <div class="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs hover:border-indigo-500/50 transition">
                            <div class="w-9 h-9 rounded-xl bg-indigo-50 dark:bg-indigo-950/80 text-indigo-600 dark:text-indigo-400 flex items-center justify-center mb-3">
                    ...
                    <div class="lg:col-span-4 flex justify-center">
                        <div class="relative w-[300px] sm:w-[320px] rounded-[44px] p-3 bg-slate-900 dark:bg-black shadow-2xl border-4 border-slate-300 dark:border-slate-700">
                            
                            <!-- Dynamic Island / Notch -->
                            <div class="absolute top-4 start-1/2 -translate-x-1/2 w-28 h-4 bg-slate-900 dark:bg-black rounded-full z-30 flex items-center justify-between px-3">
                                <div class="w-2 h-2 rounded-full bg-slate-800"></div>
                                <div class="w-2 h-2 rounded-full bg-slate-800/80"></div>
                            </div>

                            <!-- Screen Container -->
                            <div class="rounded-[36px] bg-slate-950 text-white pt-8 pb-3 px-3.5 space-y-3 border border-slate-800 text-xs">
                                ...
                                <div class="flex items-center justify-between border-b border-slate-800 pb-2.5 pt-1">
                                    <div class="flex items-center gap-2">
                                        <div class="w-7 h-7 rounded-full bg-indigo-600 flex items-center justify-center font-bold text-[10px]">
                                            ع
                                        </div>
                                        <div>
                                ...
                                <div class="p-3 rounded-xl bg-slate-900 border border-indigo-500/40 space-y-2">
                                    <div class="flex items-center justify-between text-[10px]">
                                        <span class="px-2 py-0.5 rounded-md bg-rose-500/20 text-rose-400 font-bold flex items-center gap-1">
                                    ...
                                    <button class="w-full py-1.5 rounded-lg text-[10px] font-bold bg-indigo-600 text-white hover:bg-indigo-500 transition">
                                ...
                                <div class="p-2.5 rounded-xl bg-slate-900 border border-slate-800 space-y-1.5">
                                    <div class="flex items-center justify-between text-[10px] text-slate-300">
                                        <span class="font-semibold flex items-center gap-1 line-clamp-1">
                                            <x-heroicon-o-play-circle class="w-3.5 h-3.5 text-indigo-400 shrink-0"/>
                                            {{ __('edu_bridge.student_app.mockup.recorded_title') }}
                                        </span>
                                    </div>
                                    <!-- Progress bar -->
                                    <div class="w-full bg-slate-800 rounded-full h-1 overflow-hidden">
                                        <div class="bg-indigo-500 h-full w-2/3 rounded-full"></div>
                                    </div>
                                ...
                                <div class="p-2 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                        <div class="w-5 h-5 rounded-md bg-emerald-500/20 text-emerald-400 flex items-center justify-center shrink-0">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-emerald-400 text-[9px]">{{ __('edu_bridge.student_app.mockup.task_grade') }}</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="p-2 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                        <div class="w-5 h-5 rounded-md bg-indigo-500/20 text-indigo-400 flex items-center justify-center shrink-0">
                                    ...
                                    <span class="text-[9px] px-2 py-0.5 rounded-md bg-indigo-600 text-white font-bold">
                                ...
                                <div class="pt-2 border-t border-slate-800 flex items-center justify-around text-[9px] text-slate-400">
                                    <div class="flex flex-col items-center text-indigo-400 font-bold">
        ...
        <section id="portals" class="py-16 lg:py-24 relative border-b border-slate-200/80 dark:border-slate-800/80">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
                
                <div class="text-center max-w-2xl mx-auto mb-14">
                    <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-300 border border-indigo-200/80 dark:border-indigo-800/80 mb-3">
                        <x-heroicon-o-squares-2x2 class="w-4 h-4 text-indigo-600"/>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                    ...
                    <!-- 1. Admin Portal -->
                    <div class="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs hover:shadow-md transition">
                        <div class="w-10 h-10 rounded-xl bg-indigo-50 dark:bg-indigo-950/80 text-indigo-600 dark:text-indigo-400 flex items-center justify-center mb-4">
                            <x-heroicon-o-building-library class="w-5 h-5"/>
                        </div>
                        <span class="inline-block text-[10px] font-bold text-indigo-600 dark:text-indigo-400 mb-1.5">
        ...
        <section id="features" class="py-16 lg:py-24 bg-slate-50/70 dark:bg-[#060911]/80 relative border-b border-slate-200/80 dark:border-slate-800/80">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
                
                <div class="text-center max-w-2xl mx-auto mb-14">
                    <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-300 border border-indigo-200/80 dark:border-indigo-800/80 mb-3">
                        <x-heroicon-o-sparkles class="w-4 h-4 text-indigo-600"/>
        ...
        <section id="modules" class="py-16 lg:py-24 relative border-b border-slate-200/80 dark:border-slate-800/80">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div class="flex flex-wrap items-center justify-center gap-2 mb-8">
                    ...
                    <button class="module-tab-btn px-4 py-2.5 rounded-xl text-xs sm:text-sm font-semibold transition cursor-pointer" data-tab="financials">
                        {{ __('edu_bridge.modules_tab.tabs.financials') }}
                    </button>
                ...
                <!-- Tab Panes Card -->
                <div class="rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-md p-6 sm:p-10">
                    ...
                    <div id="tab-academic" class="module-tab-pane">
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                                ...
                                <ul class="space-y-2.5 pt-2">
                                    @foreach(__('edu_bridge.modules_tab.details.academic.points') as $point)
                                        <li class="flex items-center gap-2.5 text-xs sm:text-sm text-slate-700 dark:text-slate-300">
                                            <div class="w-5 h-5 rounded-md bg-indigo-50 dark:bg-indigo-950/80 text-indigo-600 dark:text-indigo-400 flex items-center justify-center shrink-0">
                            ...
                            <div class="lg:col-span-4 p-5 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-center">
                                <x-heroicon-o-calendar-days class="w-10 h-10 text-indigo-600 dark:text-indigo-400 mx-auto mb-2"/>
                    ...
                    <div id="tab-lms_video" class="module-tab-pane hidden">
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                            ...
                            <div class="lg:col-span-4 p-5 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-center">
                                <x-heroicon-o-lock-closed class="w-10 h-10 text-indigo-600 dark:text-indigo-400 mx-auto mb-2"/>
                    ...
                    <div id="tab-marketing" class="module-tab-pane hidden">
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                            ...
                            <div class="lg:col-span-4 p-5 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-center">
                                <x-heroicon-o-chat-bubble-bottom-center-text class="w-10 h-10 text-emerald-600 dark:text-emerald-400 mx-auto mb-2"/>
                    ...
                    <!-- 4. Financials Tab -->
                    <div id="tab-financials" class="module-tab-pane hidden">
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                            <div class="lg:col-span-8 space-y-4">
                                <h3 class="text-xl font-bold text-slate-900 dark:text-white">
                                    {{ __('edu_bridge.modules_tab.details.financials.heading') }}
                                </h3>
                                <p class="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                                    {{ __('edu_bridge.modules_tab.details.financials.desc') }}
                                </p>
                                <ul class="space-y-2.5 pt-2">
                                    @foreach(__('edu_bridge.modules_tab.details.financials.points') as $point)
                                        <li class="flex items-center gap-2.5 text-xs sm:text-sm text-slate-700 dark:text-slate-300">
                                            <div class="w-5 h-5 rounded-md bg-indigo-50 dark:bg-indigo-950/80 text-indigo-600 dark:text-indigo-400 flex items-center justify-center shrink-0">
                                                <x-heroicon-o-check class="w-3.5 h-3.5"/>
                                            </div>
                            ...
                            <div class="lg:col-span-4 p-5 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-center">
                                <x-heroicon-o-calculator class="w-10 h-10 text-indigo-600 dark:text-indigo-400 mx-auto mb-2"/>
                                <div class="text-sm font-bold text-slate-900 dark:text-white">حسابات وأقساط دقيقة</div>
                                <div class="text-xs text-slate-500 dark:text-slate-400 mt-1">متابعة دفعات الطلاب وفواتير فوري وأرباح المدرسين.</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab-support" class="module-tab-pane hidden">
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                            ...
                            <div class="lg:col-span-4 p-5 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-center">
                                <x-heroicon-o-chart-bar-square class="w-10 h-10 text-indigo-600 dark:text-indigo-400 mx-auto mb-2"/>
        ...
        <section id="pricing" class="py-16 lg:py-24 bg-slate-50/70 dark:bg-[#060911]/80 relative border-b border-slate-200/80 dark:border-slate-800/80">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div class="text-center max-w-2xl mx-auto mb-10">
                    ...
                    <!-- Billing Toggle -->
                    <div class="mt-6 inline-flex items-center p-1.5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs">
                        ...
                        <button id="billing-yearly-btn" class="billing-toggle-btn px-4 py-2 rounded-xl text-xs font-bold transition cursor-pointer flex items-center gap-1.5">
                            ...
                            <span class="px-1.5 py-0.5 rounded-full bg-emerald-100 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-300 text-[10px] font-bold">20%</span>
                        </button>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
                    ...
                    <!-- 1. Starter Plan -->
                    <div class="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm p-8 flex flex-col justify-between hover:border-slate-300 dark:hover:border-slate-700 transition">
                        <div>
                            ...
                            <div class="mt-3 px-3 py-1.5 rounded-lg bg-slate-50 dark:bg-slate-800/50 text-[11px] font-semibold text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 inline-block">
                                {{ __('edu_bridge.pricing.plans.starter.students_limit') }}
                            </div>

                            <ul class="mt-6 space-y-3 border-t border-slate-100 dark:border-slate-800 pt-6">
                                @foreach(__('edu_bridge.pricing.plans.starter.features') as $feature)
                                    <li class="flex items-start gap-2.5 text-xs text-slate-700 dark:text-slate-300">
                                        <x-heroicon-s-check class="w-4 h-4 text-emerald-500 shrink-0 mt-0.5"/>
                                        <span>{{ $feature }}</span>
                                    </li>
                                @endforeach
                            </ul>
                        ...
                        <div class="pt-8">
                            <a href="#demo-form" data-plan="starter" class="plan-cta-btn block w-full py-3 rounded-xl text-center text-xs font-bold text-slate-800 dark:text-slate-200 bg-slate-100 dark:bg-slate-800 hover:bg-indigo-600 hover:text-white transition">
                    ...
                    <div class="relative rounded-3xl bg-white dark:bg-slate-900 border-2 border-indigo-600 shadow-xl p-8 flex flex-col justify-between">
                        <!-- Top Tag -->
                        <div class="absolute -top-3.5 start-1/2 -translate-x-1/2 px-3 py-1 rounded-full bg-indigo-600 text-white text-[10px] font-bold shadow-sm">
                        ...
                        <div>
                            ...
                            <!-- Price Monthly -->
                            <div class="price-box-monthly mt-5 flex items-baseline gap-1">
                                <span class="text-3xl font-extrabold text-indigo-600 dark:text-indigo-400">{{ __('edu_bridge.pricing.plans.professional.monthly_price') }}</span>
                            ...
                            <!-- Price Yearly -->
                            <div class="price-box-yearly hidden mt-5 flex items-baseline gap-1">
                                <span class="text-3xl font-extrabold text-indigo-600 dark:text-indigo-400">{{ __('edu_bridge.pricing.plans.professional.yearly_price') }}</span>
                                <span class="text-xs text-slate-500 font-semibold">{{ __('edu_bridge.pricing.plans.professional.currency') }} / سنوياً</span>
                            </div>

                            <div class="mt-3 px-3 py-1.5 rounded-lg bg-indigo-50 dark:bg-indigo-950/60 text-[11px] font-semibold text-indigo-700 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-800 inline-block">
                            ...
                            <ul class="mt-6 space-y-3 border-t border-slate-100 dark:border-slate-800 pt-6">
                                @foreach(__('edu_bridge.pricing.plans.professional.features') as $feature)
                                    <li class="flex items-start gap-2.5 text-xs text-slate-700 dark:text-slate-300">
                                        <x-heroicon-s-check class="w-4 h-4 text-indigo-600 dark:text-indigo-400 shrink-0 mt-0.5"/>
                        ...
                        <div class="pt-8">
                            <a href="#demo-form" data-plan="professional" class="plan-cta-btn block w-full py-3 rounded-xl text-center text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-500 shadow-sm transition">
                    ...
                    <div class="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm p-8 flex flex-col justify-between hover:border-slate-300 dark:hover:border-slate-700 transition">
                        ...
                        <div class="pt-8">
                            <a href="#demo-form" data-plan="enterprise" class="plan-cta-btn block w-full py-3 rounded-xl text-center text-xs font-bold text-slate-800 dark:text-slate-200 bg-slate-100 dark:bg-slate-800 hover:bg-indigo-600 hover:text-white transition">
        ...
        <section id="faq" class="py-16 lg:py-24 relative border-b border-slate-200/80 dark:border-slate-800/80">
            <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 relative z-10">
                
                <div class="text-center max-w-2xl mx-auto mb-12">
                    <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-300 border border-indigo-200/80 dark:border-indigo-800/80 mb-3">
                        <x-heroicon-o-question-mark-circle class="w-4 h-4 text-indigo-600"/>
                ...
                <div class="space-y-4">
                    @foreach(__('edu_bridge.faq.items') as $index => $item)
                        <div class="faq-item rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs overflow-hidden">
                            ...
                            <div class="faq-answer {{ $index === 0 ? '' : 'hidden' }} px-6 pb-5 text-xs sm:text-sm text-slate-600 dark:text-slate-400 leading-relaxed border-t border-slate-100 dark:border-slate-800/60 pt-3">
                                {{ $item['a'] }}
                            </div>
                        </div>
                    @endforeach
        ...
        <section id="demo-form" class="py-16 lg:py-24 bg-slate-50/70 dark:bg-[#060911]/80 relative">
            <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div class="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden">
                    <div class="grid grid-cols-1 lg:grid-cols-12">
                        ...
                        <!-- Left Info Column (Modern Slate & Indigo Theme) -->
                        <div class="lg:col-span-5 p-8 sm:p-10 bg-gradient-to-br from-slate-900 via-[#0d1424] to-slate-950 text-white flex flex-col justify-between relative overflow-hidden border-b lg:border-b-0 lg:border-e border-slate-800">
                            
                            <!-- Subtle Ambient Glow -->
                            <div class="pointer-events-none absolute -top-12 -start-12 w-48 h-48 rounded-full bg-indigo-500/15 blur-2xl"></div>
                            <div class="pointer-events-none absolute -bottom-12 -end-12 w-48 h-48 rounded-full bg-emerald-500/10 blur-2xl"></div>

                            <div class="space-y-6 relative z-10">
                                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-indigo-500/20 text-indigo-300 text-xs font-bold border border-indigo-500/30">
                            ...
                            <form id="edu-demo-form" action="{{ route('edu-bridge.demo') }}" method="POST" class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="name" name="name" required placeholder="{{ __('edu_bridge.demo.form.name_placeholder') }}"
                                           class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white text-xs focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition"/>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea id="message" name="message" rows="3" placeholder="{{ __('edu_bridge.demo.form.message_placeholder') }}"
                                              class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white text-xs focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition"></textarea>
                                </div>

                                <!-- Submit Button -->
                                <div class="pt-2">
                                    <button type="submit" id="submit-demo-btn"
                                            class="w-full py-3.5 px-6 rounded-xl text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-500 shadow-sm transition flex items-center justify-center gap-2 cursor-pointer">
    ...
    <!-- FOOTER -->
    <footer class="border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-[#070b13] py-10">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div class="flex flex-wrap items-center justify-center gap-6 text-xs font-medium text-slate-600 dark:text-slate-400">
                    <a href="#student-app" class="hover:text-indigo-600 transition">{{ __('edu_bridge.nav.student_app') }}</a>
                    <a href="#portals" class="hover:text-indigo-600 transition">{{ __('edu_bridge.nav.portals') }}</a>
                    <a href="#features" class="hover:text-indigo-600 transition">{{ __('edu_bridge.nav.features') }}</a>
                    <a href="#modules" class="hover:text-indigo-600 transition">{{ __('edu_bridge.nav.modules') }}</a>
                    <a href="#pricing" class="hover:text-indigo-600 transition">{{ __('edu_bridge.nav.pricing') }}</a>
                </div>
                ...
                <div class="flex items-center gap-2.5 text-xs text-slate-400">
                    ...
                    <span>•</span>
                    <a href="{{ route('privacy-policy') }}" class="hover:text-indigo-600 underline-offset-4 hover:underline transition">
    ...
    <a aria-label="whatsapp" href="https://wa.me/{{ preg_replace('/\D/', '', $settings['whatsapp']) }}" target="_blank" 
       class="fixed bottom-6 end-6 z-50 flex h-12 w-12 items-center justify-center rounded-full text-white shadow-md transition hover:scale-105"
